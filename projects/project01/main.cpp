...
GameSettings getGameSettings() {     // has user input and is the intro to setting up the game for the logic
...
void play(int rows, int cols, int mines, int& player1Total, int& player2Total) {  // has user input and is the main game
    ...
    while (gameState == GameState::Playing) {
        ...
        while(!validInput){  // trying to make it more user sensable
            ...
            if (visibility[row][col]) {   // if the given row and col is already in visiibility board - revealed
